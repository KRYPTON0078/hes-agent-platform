...
@Component
public class TraceProbe056 implements TraceProbe {
    @Override public String id() { return "TRC-056"; }
    @Override public String operation() { return "COMMAND_ACK"; }
    @Override public String spanName() { return "hes.command_ack.probe056"; }
