...
@Component
public class TraceProbe018 implements TraceProbe {
    @Override public String id() { return "TRC-018"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe018"; }
