...
@Component
public class TraceProbe072 implements TraceProbe {
    @Override public String id() { return "TRC-072"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe072"; }
