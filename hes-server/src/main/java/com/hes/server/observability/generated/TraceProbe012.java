...
@Component
public class TraceProbe012 implements TraceProbe {
    @Override public String id() { return "TRC-012"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe012"; }
