...
@Component
public class TraceProbe046 implements TraceProbe {
    @Override public String id() { return "TRC-046"; }
    @Override public String operation() { return "SCHEDULE_EVAL"; }
    @Override public String spanName() { return "hes.schedule_eval.probe046"; }
