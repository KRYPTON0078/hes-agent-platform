...
@Component
public class TraceProbe000 implements TraceProbe {
    @Override public String id() { return "TRC-000"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe000"; }
