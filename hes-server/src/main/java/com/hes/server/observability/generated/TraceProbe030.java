...
@Component
public class TraceProbe030 implements TraceProbe {
    @Override public String id() { return "TRC-030"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe030"; }
