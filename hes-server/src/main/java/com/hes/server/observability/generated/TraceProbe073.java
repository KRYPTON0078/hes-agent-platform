...
@Component
public class TraceProbe073 implements TraceProbe {
    @Override public String id() { return "TRC-073"; }
    @Override public String operation() { return "AGENT_TELEMETRY"; }
    @Override public String spanName() { return "hes.agent_telemetry.probe073"; }
