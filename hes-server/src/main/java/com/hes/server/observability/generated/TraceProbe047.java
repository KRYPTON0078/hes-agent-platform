...
@Component
public class TraceProbe047 implements TraceProbe {
    @Override public String id() { return "TRC-047"; }
    @Override public String operation() { return "DISPATCH_EVAL"; }
    @Override public String spanName() { return "hes.dispatch_eval.probe047"; }
