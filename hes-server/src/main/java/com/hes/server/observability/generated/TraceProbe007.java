...
@Component
public class TraceProbe007 implements TraceProbe {
    @Override public String id() { return "TRC-007"; }
    @Override public String operation() { return "AGENT_TELEMETRY"; }
    @Override public String spanName() { return "hes.agent_telemetry.probe007"; }
