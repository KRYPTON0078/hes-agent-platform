...
@Component
public class TraceProbe054 implements TraceProbe {
    @Override public String id() { return "TRC-054"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe054"; }
