...
@Component
public class TraceProbe058 implements TraceProbe {
    @Override public String id() { return "TRC-058"; }
    @Override public String operation() { return "SCHEDULE_EVAL"; }
    @Override public String spanName() { return "hes.schedule_eval.probe058"; }
