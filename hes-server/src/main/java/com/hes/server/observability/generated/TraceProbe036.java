...
@Component
public class TraceProbe036 implements TraceProbe {
    @Override public String id() { return "TRC-036"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe036"; }
