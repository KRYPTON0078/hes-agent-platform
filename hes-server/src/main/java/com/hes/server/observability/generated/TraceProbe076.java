...
@Component
public class TraceProbe076 implements TraceProbe {
    @Override public String id() { return "TRC-076"; }
    @Override public String operation() { return "SCHEDULE_EVAL"; }
    @Override public String spanName() { return "hes.schedule_eval.probe076"; }
