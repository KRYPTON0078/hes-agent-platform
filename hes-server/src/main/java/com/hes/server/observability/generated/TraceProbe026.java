...
@Component
public class TraceProbe026 implements TraceProbe {
    @Override public String id() { return "TRC-026"; }
    @Override public String operation() { return "COMMAND_ACK"; }
    @Override public String spanName() { return "hes.command_ack.probe026"; }
