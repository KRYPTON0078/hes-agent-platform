...
@Component
public class TraceProbe078 implements TraceProbe {
    @Override public String id() { return "TRC-078"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe078"; }
