...
@Component
public class TraceProbe005 implements TraceProbe {
    @Override public String id() { return "TRC-005"; }
    @Override public String operation() { return "DISPATCH_EVAL"; }
    @Override public String spanName() { return "hes.dispatch_eval.probe005"; }
