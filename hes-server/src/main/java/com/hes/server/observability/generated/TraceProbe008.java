...
@Component
public class TraceProbe008 implements TraceProbe {
    @Override public String id() { return "TRC-008"; }
    @Override public String operation() { return "COMMAND_ACK"; }
    @Override public String spanName() { return "hes.command_ack.probe008"; }
