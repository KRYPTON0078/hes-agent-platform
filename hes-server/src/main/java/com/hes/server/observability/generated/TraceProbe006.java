...
@Component
public class TraceProbe006 implements TraceProbe {
    @Override public String id() { return "TRC-006"; }
    @Override public String operation() { return "AGENT_REGISTER"; }
    @Override public String spanName() { return "hes.agent_register.probe006"; }
