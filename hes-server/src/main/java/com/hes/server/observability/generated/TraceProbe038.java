...
@Component
public class TraceProbe038 implements TraceProbe {
    @Override public String id() { return "TRC-038"; }
    @Override public String operation() { return "COMMAND_ACK"; }
    @Override public String spanName() { return "hes.command_ack.probe038"; }
