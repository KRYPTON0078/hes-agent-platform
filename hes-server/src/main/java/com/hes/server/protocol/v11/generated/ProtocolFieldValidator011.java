...
@Component
public class ProtocolFieldValidator011 implements ProtocolFieldValidator {
    @Override public String id() { return "PFV-011"; }
    @Override public String fieldName() { return "protocolVersion"; }
    @Override public Optional<String> validate(Object value) {
        return "1.1".equals(String.valueOf(value)) ? Optional.empty() : Optional.of("PFV-011 protocol must be 1.1");
    }
}