...
@Component
public class ProtocolFieldValidator043 implements ProtocolFieldValidator {
    @Override public String id() { return "PFV-043"; }
    @Override public String fieldName() { return "protocolVersion"; }
    @Override public Optional<String> validate(Object value) {
        return "1.1".equals(String.valueOf(value)) ? Optional.empty() : Optional.of("PFV-043 protocol must be 1.1");
    }
}