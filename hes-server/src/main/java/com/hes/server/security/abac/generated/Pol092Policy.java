...
@Component
public class Pol092Policy implements AbacPolicy {
    @Override public String id() { return "POL-092"; }
    @Override public String description() { return "Allow READ_AUDIT only when subject role includes ADMIN"; }
    @Override
