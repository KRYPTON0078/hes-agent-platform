...
@Component
public class Ir080Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-080"; }
    @Override public String title() { return "Respond to security incident variant 80"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-080 authenticity from audit trail",
