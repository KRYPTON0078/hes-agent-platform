...
@Component
public class Ir071Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-071"; }
    @Override public String title() { return "Respond to security incident variant 71"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-071 authenticity from audit trail",
