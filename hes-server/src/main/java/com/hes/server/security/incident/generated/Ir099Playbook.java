...
@Component
public class Ir099Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-099"; }
    @Override public String title() { return "Respond to security incident variant 99"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-099 authenticity from audit trail",
