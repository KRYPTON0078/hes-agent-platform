...
@Component
public class Ir023Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-023"; }
    @Override public String title() { return "Respond to security incident variant 23"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-023 authenticity from audit trail",
