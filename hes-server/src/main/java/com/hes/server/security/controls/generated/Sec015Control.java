...
@Component
public class Sec015Control implements SecurityControl {
    @Override public String id() { return "SEC-015"; }
    @Override public String title() { return "Enforce EXPORT guard against InformationDisclosure"; }
