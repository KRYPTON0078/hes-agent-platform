...
@Component
public class Ir059Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-059"; }
    @Override public String title() { return "Respond to security incident variant 59"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-059 authenticity from audit trail",
