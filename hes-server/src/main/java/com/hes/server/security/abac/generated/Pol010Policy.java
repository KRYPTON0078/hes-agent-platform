...
@Component
public class Pol010Policy implements AbacPolicy {
    @Override public String id() { return "POL-010"; }
    @Override public String description() { return "Allow ROTATE_KEY only when subject role includes OPERATOR"; }
    @Override
