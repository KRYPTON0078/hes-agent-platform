...
@Component
public class Sec138Control implements SecurityControl {
    @Override public String id() { return "SEC-138"; }
    @Override public String title() { return "Enforce TELEMETRY guard against Spoofing"; }
