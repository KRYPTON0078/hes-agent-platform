...
@Component
public class Sec133Control implements SecurityControl {
    @Override public String id() { return "SEC-133"; }
    @Override public String title() { return "Enforce AUDIT_READ guard against Tampering"; }
