...
@Component
public class Ir029Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-029"; }
    @Override public String title() { return "Respond to security incident variant 29"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-029 authenticity from audit trail",
