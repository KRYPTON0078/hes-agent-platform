...
@Component
public class Ir036Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-036"; }
    @Override public String title() { return "Respond to security incident variant 36"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-036 authenticity from audit trail",
