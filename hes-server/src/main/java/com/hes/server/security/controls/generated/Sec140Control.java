...
@Component
public class Sec140Control implements SecurityControl {
    @Override public String id() { return "SEC-140"; }
    @Override public String title() { return "Enforce REGISTER guard against Repudiation"; }
