...
@Component
public class Ir092Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-092"; }
    @Override public String title() { return "Respond to security incident variant 92"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-092 authenticity from audit trail",
