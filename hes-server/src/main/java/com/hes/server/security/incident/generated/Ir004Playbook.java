...
@Component
public class Ir004Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-004"; }
    @Override public String title() { return "Respond to security incident variant 4"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-004 authenticity from audit trail",
