...
@Component
public class Ir060Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-060"; }
    @Override public String title() { return "Respond to security incident variant 60"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-060 authenticity from audit trail",
