...
@Component
public class Ir075Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-075"; }
    @Override public String title() { return "Respond to security incident variant 75"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-075 authenticity from audit trail",
