...
@Component
public class Ir041Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-041"; }
    @Override public String title() { return "Respond to security incident variant 41"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-041 authenticity from audit trail",
