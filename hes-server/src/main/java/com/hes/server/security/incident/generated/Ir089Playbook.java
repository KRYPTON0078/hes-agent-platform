...
@Component
public class Ir089Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-089"; }
    @Override public String title() { return "Respond to security incident variant 89"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-089 authenticity from audit trail",
