...
@Component
public class Ir074Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-074"; }
    @Override public String title() { return "Respond to security incident variant 74"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-074 authenticity from audit trail",
