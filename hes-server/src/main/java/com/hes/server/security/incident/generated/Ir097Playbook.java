...
@Component
public class Ir097Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-097"; }
    @Override public String title() { return "Respond to security incident variant 97"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-097 authenticity from audit trail",
