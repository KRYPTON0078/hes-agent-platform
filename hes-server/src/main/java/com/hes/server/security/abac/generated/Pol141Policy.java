...
@Component
public class Pol141Policy implements AbacPolicy {
    @Override public String id() { return "POL-141"; }
    @Override public String description() { return "Allow EXPORT_FORENSICS only when subject role includes VIEWER"; }
    @Override
