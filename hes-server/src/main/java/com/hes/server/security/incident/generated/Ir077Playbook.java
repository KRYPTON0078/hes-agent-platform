...
@Component
public class Ir077Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-077"; }
    @Override public String title() { return "Respond to security incident variant 77"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-077 authenticity from audit trail",
