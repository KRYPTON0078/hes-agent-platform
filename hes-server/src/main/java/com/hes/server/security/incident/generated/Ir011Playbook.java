...
@Component
public class Ir011Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-011"; }
    @Override public String title() { return "Respond to security incident variant 11"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-011 authenticity from audit trail",
