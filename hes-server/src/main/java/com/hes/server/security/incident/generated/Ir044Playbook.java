...
@Component
public class Ir044Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-044"; }
    @Override public String title() { return "Respond to security incident variant 44"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-044 authenticity from audit trail",
