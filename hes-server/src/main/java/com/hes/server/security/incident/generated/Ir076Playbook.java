...
@Component
public class Ir076Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-076"; }
    @Override public String title() { return "Respond to security incident variant 76"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-076 authenticity from audit trail",
