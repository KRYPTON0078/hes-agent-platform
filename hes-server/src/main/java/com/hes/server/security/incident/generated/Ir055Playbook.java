...
@Component
public class Ir055Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-055"; }
    @Override public String title() { return "Respond to security incident variant 55"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-055 authenticity from audit trail",
