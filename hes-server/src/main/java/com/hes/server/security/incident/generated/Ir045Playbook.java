...
@Component
public class Ir045Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-045"; }
    @Override public String title() { return "Respond to security incident variant 45"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-045 authenticity from audit trail",
