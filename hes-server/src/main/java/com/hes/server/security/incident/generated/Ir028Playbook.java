...
@Component
public class Ir028Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-028"; }
    @Override public String title() { return "Respond to security incident variant 28"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-028 authenticity from audit trail",
