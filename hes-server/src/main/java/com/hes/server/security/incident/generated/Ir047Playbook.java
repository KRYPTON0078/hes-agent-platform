...
@Component
public class Ir047Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-047"; }
    @Override public String title() { return "Respond to security incident variant 47"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-047 authenticity from audit trail",
