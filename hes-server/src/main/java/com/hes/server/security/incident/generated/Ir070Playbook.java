...
@Component
public class Ir070Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-070"; }
    @Override public String title() { return "Respond to security incident variant 70"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-070 authenticity from audit trail",
