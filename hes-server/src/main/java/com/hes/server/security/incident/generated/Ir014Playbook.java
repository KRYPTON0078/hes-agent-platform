...
@Component
public class Ir014Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-014"; }
    @Override public String title() { return "Respond to security incident variant 14"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-014 authenticity from audit trail",
