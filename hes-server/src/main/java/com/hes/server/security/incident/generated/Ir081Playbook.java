...
@Component
public class Ir081Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-081"; }
    @Override public String title() { return "Respond to security incident variant 81"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-081 authenticity from audit trail",
