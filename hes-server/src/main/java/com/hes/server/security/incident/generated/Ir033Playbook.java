...
@Component
public class Ir033Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-033"; }
    @Override public String title() { return "Respond to security incident variant 33"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-033 authenticity from audit trail",
