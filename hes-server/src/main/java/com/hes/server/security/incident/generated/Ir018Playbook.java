...
@Component
public class Ir018Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-018"; }
    @Override public String title() { return "Respond to security incident variant 18"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-018 authenticity from audit trail",
