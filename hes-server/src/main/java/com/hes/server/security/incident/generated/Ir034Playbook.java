...
@Component
public class Ir034Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-034"; }
    @Override public String title() { return "Respond to security incident variant 34"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-034 authenticity from audit trail",
