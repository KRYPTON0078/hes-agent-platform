...
@Component
public class Ir100Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-100"; }
    @Override public String title() { return "Respond to security incident variant 100"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-100 authenticity from audit trail",
