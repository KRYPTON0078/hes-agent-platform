...
@Component
public class Ir082Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-082"; }
    @Override public String title() { return "Respond to security incident variant 82"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-082 authenticity from audit trail",
