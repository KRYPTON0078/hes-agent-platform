...
@Component
public class Sec058Control implements SecurityControl {
    @Override public String id() { return "SEC-058"; }
    @Override public String title() { return "Enforce TELEMETRY guard against DenialOfService"; }
    @Override public String threat() { return "DenialOfService"; }
    @Override public String mitigation() { return "Require authenticated principal and validate TELEMETRY attributes before execution"; }
    ...
    public boolean evaluate(SecurityControlContext context) {
        ...
        if ("TELEMETRY".equals(context.action()) && (context.actor() == null || context.actor().isBlank())) {
            return false;
        }
        return true;
    }
