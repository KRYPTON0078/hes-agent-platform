...
@Component
public class Ir027Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-027"; }
    @Override public String title() { return "Respond to security incident variant 27"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-027 authenticity from audit trail",
