...
@Component
public class Ir016Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-016"; }
    @Override public String title() { return "Respond to security incident variant 16"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-016 authenticity from audit trail",
