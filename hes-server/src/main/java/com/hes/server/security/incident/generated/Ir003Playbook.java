...
@Component
public class Ir003Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-003"; }
    @Override public String title() { return "Respond to security incident variant 3"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-003 authenticity from audit trail",
