...
@Component
public class Pol132Policy implements AbacPolicy {
    @Override public String id() { return "POL-132"; }
    @Override public String description() { return "Allow READ_AUDIT only when subject role includes VIEWER"; }
    @Override
