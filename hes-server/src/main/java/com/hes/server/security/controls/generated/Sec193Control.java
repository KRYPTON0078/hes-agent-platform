...
@Component
public class Sec193Control implements SecurityControl {
    @Override public String id() { return "SEC-193"; }
    @Override public String title() { return "Enforce COMMAND guard against Tampering"; }
