...
@Component
public class Ir096Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-096"; }
    @Override public String title() { return "Respond to security incident variant 96"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-096 authenticity from audit trail",
