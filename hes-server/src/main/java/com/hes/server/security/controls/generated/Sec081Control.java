...
@Component
public class Sec081Control implements SecurityControl {
    @Override public String id() { return "SEC-081"; }
    @Override public String title() { return "Enforce COMMAND guard against InformationDisclosure"; }
