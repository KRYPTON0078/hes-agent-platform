...
@Component
public class Ir061Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-061"; }
    @Override public String title() { return "Respond to security incident variant 61"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-061 authenticity from audit trail",
