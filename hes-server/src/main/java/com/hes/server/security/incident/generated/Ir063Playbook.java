...
@Component
public class Ir063Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-063"; }
    @Override public String title() { return "Respond to security incident variant 63"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-063 authenticity from audit trail",
