...
@Component
public class Ir037Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-037"; }
    @Override public String title() { return "Respond to security incident variant 37"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-037 authenticity from audit trail",
