...
@Component
public class Ir032Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-032"; }
    @Override public String title() { return "Respond to security incident variant 32"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-032 authenticity from audit trail",
