...
@Component
public class Ir026Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-026"; }
    @Override public String title() { return "Respond to security incident variant 26"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-026 authenticity from audit trail",
