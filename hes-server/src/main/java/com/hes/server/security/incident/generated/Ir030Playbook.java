...
@Component
public class Ir030Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-030"; }
    @Override public String title() { return "Respond to security incident variant 30"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-030 authenticity from audit trail",
