...
@Component
public class Ir058Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-058"; }
    @Override public String title() { return "Respond to security incident variant 58"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-058 authenticity from audit trail",
