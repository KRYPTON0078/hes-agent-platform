...
@Component
public class Ir093Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-093"; }
    @Override public String title() { return "Respond to security incident variant 93"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-093 authenticity from audit trail",
