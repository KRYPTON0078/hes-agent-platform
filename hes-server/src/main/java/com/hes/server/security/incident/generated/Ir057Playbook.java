...
@Component
public class Ir057Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-057"; }
    @Override public String title() { return "Respond to security incident variant 57"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-057 authenticity from audit trail",
