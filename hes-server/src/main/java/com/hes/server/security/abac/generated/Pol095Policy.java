...
@Component
public class Pol095Policy implements AbacPolicy {
    @Override public String id() { return "POL-095"; }
    @Override public String description() { return "Allow VIEW_FLEET only when subject role includes ADMIN"; }
    @Override
