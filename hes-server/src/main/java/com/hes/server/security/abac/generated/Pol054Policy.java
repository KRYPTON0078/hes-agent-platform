...
@Component
public class Pol054Policy implements AbacPolicy {
    @Override public String id() { return "POL-054"; }
    @Override public String description() { return "Allow MANAGE_SITE only when subject role includes VIEWER"; }
    @Override
