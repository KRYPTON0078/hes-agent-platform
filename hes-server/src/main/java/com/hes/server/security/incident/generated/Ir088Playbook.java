...
@Component
public class Ir088Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-088"; }
    @Override public String title() { return "Respond to security incident variant 88"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-088 authenticity from audit trail",
