...
@Component
public class Ir052Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-052"; }
    @Override public String title() { return "Respond to security incident variant 52"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-052 authenticity from audit trail",
