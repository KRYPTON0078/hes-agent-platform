...
@Component
public class Ir067Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-067"; }
    @Override public String title() { return "Respond to security incident variant 67"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-067 authenticity from audit trail",
