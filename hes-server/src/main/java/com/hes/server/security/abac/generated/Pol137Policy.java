...
@Component
public class Pol137Policy implements AbacPolicy {
    @Override public String id() { return "POL-137"; }
    @Override public String description() { return "Allow ISSUE_COMMAND only when subject role includes ADMIN"; }
    @Override
