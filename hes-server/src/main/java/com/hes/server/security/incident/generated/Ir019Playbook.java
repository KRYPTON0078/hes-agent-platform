...
@Component
public class Ir019Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-019"; }
    @Override public String title() { return "Respond to security incident variant 19"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-019 authenticity from audit trail",
