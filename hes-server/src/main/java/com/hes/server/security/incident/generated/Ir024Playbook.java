...
@Component
public class Ir024Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-024"; }
    @Override public String title() { return "Respond to security incident variant 24"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-024 authenticity from audit trail",
