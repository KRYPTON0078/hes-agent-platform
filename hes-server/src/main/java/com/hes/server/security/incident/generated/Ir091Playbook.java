...
@Component
public class Ir091Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-091"; }
    @Override public String title() { return "Respond to security incident variant 91"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-091 authenticity from audit trail",
