...
@Component
public class Ir078Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-078"; }
    @Override public String title() { return "Respond to security incident variant 78"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-078 authenticity from audit trail",
