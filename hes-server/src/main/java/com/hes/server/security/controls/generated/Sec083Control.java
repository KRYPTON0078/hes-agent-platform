...
@Component
public class Sec083Control implements SecurityControl {
    @Override public String id() { return "SEC-083"; }
    @Override public String title() { return "Enforce KEY_ROTATE guard against ElevationOfPrivilege"; }
