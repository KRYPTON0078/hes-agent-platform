...
@Component
public class Sec004Control implements SecurityControl {
    @Override public String id() { return "SEC-004"; }
    @Override public String title() { return "Enforce REGISTER guard against DenialOfService"; }
