...
@Component
public class Ir022Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-022"; }
    @Override public String title() { return "Respond to security incident variant 22"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-022 authenticity from audit trail",
