...
@Component
public class Ir094Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-094"; }
    @Override public String title() { return "Respond to security incident variant 94"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-094 authenticity from audit trail",
