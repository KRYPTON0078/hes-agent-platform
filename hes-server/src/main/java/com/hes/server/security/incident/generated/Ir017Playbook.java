...
@Component
public class Ir017Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-017"; }
    @Override public String title() { return "Respond to security incident variant 17"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-017 authenticity from audit trail",
