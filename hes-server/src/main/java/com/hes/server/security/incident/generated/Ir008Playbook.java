...
@Component
public class Ir008Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-008"; }
    @Override public String title() { return "Respond to security incident variant 8"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-008 authenticity from audit trail",
