...
@Component
public class Ir090Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-090"; }
    @Override public String title() { return "Respond to security incident variant 90"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-090 authenticity from audit trail",
