...
@Component
public class Ir066Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-066"; }
    @Override public String title() { return "Respond to security incident variant 66"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-066 authenticity from audit trail",
