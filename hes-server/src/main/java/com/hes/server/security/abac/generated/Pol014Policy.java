...
@Component
public class Pol014Policy implements AbacPolicy {
    @Override public String id() { return "POL-014"; }
    @Override public String description() { return "Allow MANAGE_SITE only when subject role includes ADMIN"; }
    @Override
