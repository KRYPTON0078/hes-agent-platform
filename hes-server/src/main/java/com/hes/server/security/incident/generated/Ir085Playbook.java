...
@Component
public class Ir085Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-085"; }
    @Override public String title() { return "Respond to security incident variant 85"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-085 authenticity from audit trail",
