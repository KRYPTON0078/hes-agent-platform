...
@Component
public class Ir012Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-012"; }
    @Override public String title() { return "Respond to security incident variant 12"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-012 authenticity from audit trail",
