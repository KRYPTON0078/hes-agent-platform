...
@Component
public class Sec055Control implements SecurityControl {
    @Override public String id() { return "SEC-055"; }
    @Override public String title() { return "Enforce EXPORT guard against Tampering"; }
