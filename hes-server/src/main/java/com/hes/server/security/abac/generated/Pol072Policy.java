...
@Component
public class Pol072Policy implements AbacPolicy {
    @Override public String id() { return "POL-072"; }
    @Override public String description() { return "Allow READ_TELEMETRY only when subject role includes VIEWER"; }
    @Override
