...
@Component
public class Ir035Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-035"; }
    @Override public String title() { return "Respond to security incident variant 35"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-035 authenticity from audit trail",
