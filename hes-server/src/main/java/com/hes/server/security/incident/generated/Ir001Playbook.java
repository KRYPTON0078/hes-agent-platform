...
@Component
public class Ir001Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-001"; }
    @Override public String title() { return "Respond to security incident variant 1"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-001 authenticity from audit trail",
