...
@Component
public class Ir038Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-038"; }
    @Override public String title() { return "Respond to security incident variant 38"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-038 authenticity from audit trail",
