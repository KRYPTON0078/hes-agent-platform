...
@Component
public class Ir086Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-086"; }
    @Override public String title() { return "Respond to security incident variant 86"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-086 authenticity from audit trail",
