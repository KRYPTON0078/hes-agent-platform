...
@Component
public class Pol005Policy implements AbacPolicy {
    @Override public String id() { return "POL-005"; }
    @Override public String description() { return "Allow EXPORT_FORENSICS only when subject role includes ADMIN"; }
    @Override
