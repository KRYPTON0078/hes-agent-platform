...
@Component
public class Ir046Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-046"; }
    @Override public String title() { return "Respond to security incident variant 46"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-046 authenticity from audit trail",
