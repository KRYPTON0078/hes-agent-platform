...
@Component
public class Ir043Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-043"; }
    @Override public String title() { return "Respond to security incident variant 43"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-043 authenticity from audit trail",
