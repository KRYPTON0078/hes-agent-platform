...
@Component
public class Sec074Control implements SecurityControl {
    @Override public String id() { return "SEC-074"; }
    @Override public String title() { return "Enforce TELEMETRY guard against Repudiation"; }
