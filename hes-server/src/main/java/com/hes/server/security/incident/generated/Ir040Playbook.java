...
@Component
public class Ir040Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-040"; }
    @Override public String title() { return "Respond to security incident variant 40"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-040 authenticity from audit trail",
