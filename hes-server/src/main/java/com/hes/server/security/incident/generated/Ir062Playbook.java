...
@Component
public class Ir062Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-062"; }
    @Override public String title() { return "Respond to security incident variant 62"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-062 authenticity from audit trail",
