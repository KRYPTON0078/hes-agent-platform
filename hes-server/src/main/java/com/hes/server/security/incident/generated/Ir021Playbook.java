...
@Component
public class Ir021Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-021"; }
    @Override public String title() { return "Respond to security incident variant 21"; }
    @Override public String severity() { return "MEDIUM"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-021 authenticity from audit trail",
