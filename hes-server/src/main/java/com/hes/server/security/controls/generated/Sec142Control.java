...
@Component
public class Sec142Control implements SecurityControl {
    @Override public String id() { return "SEC-142"; }
    @Override public String title() { return "Enforce DISABLE_DEVICE guard against DenialOfService"; }
