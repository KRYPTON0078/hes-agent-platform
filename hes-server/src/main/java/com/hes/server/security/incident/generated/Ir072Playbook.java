...
@Component
public class Ir072Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-072"; }
    @Override public String title() { return "Respond to security incident variant 72"; }
    @Override public String severity() { return "LOW"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-072 authenticity from audit trail",
