...
@Component
public class Pol050Policy implements AbacPolicy {
    @Override public String id() { return "POL-050"; }
    @Override public String description() { return "Allow ROTATE_KEY only when subject role includes ADMIN"; }
    @Override
