...
@Component
public class Ir050Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-050"; }
    @Override public String title() { return "Respond to security incident variant 50"; }
    @Override public String severity() { return "HIGH"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-050 authenticity from audit trail",
