...
@Component
public class Sec147Control implements SecurityControl {
    @Override public String id() { return "SEC-147"; }
    @Override public String title() { return "Enforce KEY_ROTATE guard against InformationDisclosure"; }
