...
@Component
public class Ir083Playbook implements IncidentPlaybook {
    @Override public String id() { return "IR-083"; }
    @Override public String title() { return "Respond to security incident variant 83"; }
    @Override public String severity() { return "CRITICAL"; }
    @Override
    public List<String> steps() {
        return List.of(
            "Confirm alert IR-083 authenticity from audit trail",
