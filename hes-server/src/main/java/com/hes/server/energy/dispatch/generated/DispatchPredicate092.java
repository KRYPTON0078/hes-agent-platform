...
@Component
public class DispatchPredicate092 implements DispatchPredicate {
    @Override public String id() { return "DSP-092"; }
    @Override public String description() { return "SOC above threshold 22 (DSP-092)"; }
