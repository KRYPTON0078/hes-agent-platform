...
@Component
public class DispatchPredicate035 implements DispatchPredicate {
    @Override public String id() { return "DSP-035"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-035)"; }
