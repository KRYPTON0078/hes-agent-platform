...
@Component
public class DispatchPredicate014 implements DispatchPredicate {
    @Override public String id() { return "DSP-014"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-014)"; }
