...
@Component
public class DispatchPredicate025 implements DispatchPredicate {
    @Override public String id() { return "DSP-025"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-025)"; }
