...
@Component
public class DispatchPredicate082 implements DispatchPredicate {
    @Override public String id() { return "DSP-082"; }
    @Override public String description() { return "SOC above threshold 12 (DSP-082)"; }
