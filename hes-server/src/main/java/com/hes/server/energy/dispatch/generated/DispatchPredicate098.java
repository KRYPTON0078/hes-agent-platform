...
@Component
public class DispatchPredicate098 implements DispatchPredicate {
    @Override public String id() { return "DSP-098"; }
    @Override public String description() { return "Site load above threshold 3.9 (DSP-098)"; }
