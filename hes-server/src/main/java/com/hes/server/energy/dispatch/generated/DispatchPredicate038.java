...
@Component
public class DispatchPredicate038 implements DispatchPredicate {
    @Override public String id() { return "DSP-038"; }
    @Override public String description() { return "Site load above threshold 3.9 (DSP-038)"; }
