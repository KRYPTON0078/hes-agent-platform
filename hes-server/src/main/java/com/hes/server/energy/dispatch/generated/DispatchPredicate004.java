...
@Component
public class DispatchPredicate004 implements DispatchPredicate {
    @Override public String id() { return "DSP-004"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-004)"; }
