...
@Component
public class DispatchPredicate063 implements DispatchPredicate {
    @Override public String id() { return "DSP-063"; }
    @Override public String description() { return "Import watts above threshold 2627 (DSP-063)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("2627")) > 0;
    }
}