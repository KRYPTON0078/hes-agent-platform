...
@Component
public class DispatchPredicate016 implements DispatchPredicate {
    @Override public String id() { return "DSP-016"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-016)"; }
