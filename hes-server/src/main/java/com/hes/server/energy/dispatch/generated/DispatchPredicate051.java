...
@Component
public class DispatchPredicate051 implements DispatchPredicate {
    @Override public String id() { return "DSP-051"; }
    @Override public String description() { return "SOC below threshold 61 (DSP-051)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        BigDecimal v = signals.getOrDefault("soc", BigDecimal.ZERO);
        return v.compareTo(new BigDecimal("61")) < 0;
    }
}