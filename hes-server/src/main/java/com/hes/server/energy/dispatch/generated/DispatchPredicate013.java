...
@Component
public class DispatchPredicate013 implements DispatchPredicate {
    @Override public String id() { return "DSP-013"; }
    @Override public String description() { return "Import watts above threshold 1177 (DSP-013)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("1177")) > 0;
    }
}