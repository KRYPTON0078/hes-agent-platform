...
@Component
public class DispatchPredicate029 implements DispatchPredicate {
    @Override public String id() { return "DSP-029"; }
    @Override public String description() { return "PV production above threshold 2.75 (DSP-029)"; }
