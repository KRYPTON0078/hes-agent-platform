...
@Component
public class DispatchPredicate079 implements DispatchPredicate {
    @Override public String id() { return "DSP-079"; }
    @Override public String description() { return "PV production above threshold 5.25 (DSP-079)"; }
