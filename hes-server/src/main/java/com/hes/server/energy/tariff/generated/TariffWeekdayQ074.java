...
@Component
public class TariffWeekdayQ074 implements TariffSlot {
    @Override public String id() { return "TAR-WD-074"; }
    ...
    @Override public BigDecimal exportRatePerKwh() { return new BigDecimal("0.084"); }
