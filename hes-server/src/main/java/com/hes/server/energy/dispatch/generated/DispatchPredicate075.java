...
@Component
public class DispatchPredicate075 implements DispatchPredicate {
    @Override public String id() { return "DSP-075"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-075)"; }
