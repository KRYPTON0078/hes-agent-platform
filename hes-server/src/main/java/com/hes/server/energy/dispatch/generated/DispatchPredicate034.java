...
@Component
public class DispatchPredicate034 implements DispatchPredicate {
    @Override public String id() { return "DSP-034"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-034)"; }
