...
@Component
public class DispatchPredicate036 implements DispatchPredicate {
    @Override public String id() { return "DSP-036"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-036)"; }
