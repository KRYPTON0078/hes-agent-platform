...
@Component
public class DispatchPredicate017 implements DispatchPredicate {
    @Override public String id() { return "DSP-017"; }
    @Override public String description() { return "Battery temperature above threshold 52 (DSP-017)"; }
