...
@Component
public class DispatchPredicate026 implements DispatchPredicate {
    @Override public String id() { return "DSP-026"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-026)"; }
