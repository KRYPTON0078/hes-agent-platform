...
@Component
public class DispatchPredicate009 implements DispatchPredicate {
    @Override public String id() { return "DSP-009"; }
    @Override public String description() { return "PV production above threshold 2.75 (DSP-009)"; }
