...
@Component
public class DispatchPredicate069 implements DispatchPredicate {
    @Override public String id() { return "DSP-069"; }
    @Override public String description() { return "PV production above threshold 2.75 (DSP-069)"; }
