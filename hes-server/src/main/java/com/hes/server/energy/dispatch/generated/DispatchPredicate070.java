...
@Component
public class DispatchPredicate070 implements DispatchPredicate {
    @Override public String id() { return "DSP-070"; }
    @Override public String description() { return "Export watts above threshold 4090 (DSP-070)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("4090")) > 0;
    }
}