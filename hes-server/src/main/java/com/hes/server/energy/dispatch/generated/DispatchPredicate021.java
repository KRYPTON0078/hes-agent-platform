...
@Component
public class DispatchPredicate021 implements DispatchPredicate {
    @Override public String id() { return "DSP-021"; }
    @Override public String description() { return "SOC below threshold 31 (DSP-021)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        BigDecimal v = signals.getOrDefault("soc", BigDecimal.ZERO);
        return v.compareTo(new BigDecimal("31")) < 0;
    }
}