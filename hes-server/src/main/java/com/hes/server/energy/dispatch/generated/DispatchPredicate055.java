...
@Component
public class DispatchPredicate055 implements DispatchPredicate {
    @Override public String id() { return "DSP-055"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-055)"; }
