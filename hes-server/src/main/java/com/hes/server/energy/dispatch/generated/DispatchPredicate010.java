...
@Component
public class DispatchPredicate010 implements DispatchPredicate {
    @Override public String id() { return "DSP-010"; }
    @Override public String description() { return "Export watts above threshold 1870 (DSP-010)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("1870")) > 0;
    }
}