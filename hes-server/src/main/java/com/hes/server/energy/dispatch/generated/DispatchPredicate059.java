...
@Component
public class DispatchPredicate059 implements DispatchPredicate {
    @Override public String id() { return "DSP-059"; }
    @Override public String description() { return "PV production above threshold 5.25 (DSP-059)"; }
