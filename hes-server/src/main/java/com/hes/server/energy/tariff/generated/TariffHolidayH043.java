...
@Component
public class TariffHolidayH043 implements TariffSlot {
    @Override public String id() { return "TAR-HOL-043"; }
    @Override public int startMinuteInclusive() { return 1290; }
    @Override public int endMinuteExclusive() { return 1320; }
