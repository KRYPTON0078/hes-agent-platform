...
@Component
public class DispatchPredicate083 implements DispatchPredicate {
    @Override public String id() { return "DSP-083"; }
    @Override public String description() { return "Import watts above threshold 3207 (DSP-083)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("3207")) > 0;
    }
}