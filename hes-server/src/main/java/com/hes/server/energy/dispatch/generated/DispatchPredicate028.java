...
@Component
public class DispatchPredicate028 implements DispatchPredicate {
    @Override public String id() { return "DSP-028"; }
    @Override public String description() { return "Site load above threshold 5.4 (DSP-028)"; }
