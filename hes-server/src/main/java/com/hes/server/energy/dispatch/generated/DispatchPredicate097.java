...
@Component
public class DispatchPredicate097 implements DispatchPredicate {
    @Override public String id() { return "DSP-097"; }
    @Override public String description() { return "Battery temperature above threshold 52 (DSP-097)"; }
