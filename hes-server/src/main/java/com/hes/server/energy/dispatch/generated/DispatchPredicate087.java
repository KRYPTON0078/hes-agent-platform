...
@Component
public class DispatchPredicate087 implements DispatchPredicate {
    @Override public String id() { return "DSP-087"; }
    @Override public String description() { return "Battery temperature above threshold 42 (DSP-087)"; }
