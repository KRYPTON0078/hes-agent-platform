...
@Component
public class DispatchPredicate008 implements DispatchPredicate {
    @Override public String id() { return "DSP-008"; }
    @Override public String description() { return "Site load above threshold 3.9 (DSP-008)"; }
