...
@Component
public class DispatchPredicate011 implements DispatchPredicate {
    @Override public String id() { return "DSP-011"; }
    @Override public String description() { return "SOC below threshold 21 (DSP-011)"; }
