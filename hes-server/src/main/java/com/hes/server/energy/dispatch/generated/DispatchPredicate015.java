...
@Component
public class DispatchPredicate015 implements DispatchPredicate {
    @Override public String id() { return "DSP-015"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-015)"; }
