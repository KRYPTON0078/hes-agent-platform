...
@Component
public class DispatchPredicate043 implements DispatchPredicate {
    @Override public String id() { return "DSP-043"; }
    @Override public String description() { return "Import watts above threshold 2047 (DSP-043)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("2047")) > 0;
    }
}