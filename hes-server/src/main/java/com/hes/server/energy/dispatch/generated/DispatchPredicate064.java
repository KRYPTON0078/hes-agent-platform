...
@Component
public class DispatchPredicate064 implements DispatchPredicate {
    @Override public String id() { return "DSP-064"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-064)"; }
