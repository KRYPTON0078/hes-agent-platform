...
@Component
public class DispatchPredicate053 implements DispatchPredicate {
    @Override public String id() { return "DSP-053"; }
    @Override public String description() { return "Import watts above threshold 2337 (DSP-053)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("2337")) > 0;
    }
}