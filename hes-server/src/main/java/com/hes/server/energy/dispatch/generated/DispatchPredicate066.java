...
@Component
public class DispatchPredicate066 implements DispatchPredicate {
    @Override public String id() { return "DSP-066"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-066)"; }
