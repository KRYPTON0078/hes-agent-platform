...
@Component
public class DispatchPredicate095 implements DispatchPredicate {
    @Override public String id() { return "DSP-095"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-095)"; }
