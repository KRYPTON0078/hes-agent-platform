...
@Component
public class DispatchPredicate057 implements DispatchPredicate {
    @Override public String id() { return "DSP-057"; }
    @Override public String description() { return "Battery temperature above threshold 52 (DSP-057)"; }
