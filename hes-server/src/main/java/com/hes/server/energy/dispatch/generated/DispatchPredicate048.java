...
@Component
public class DispatchPredicate048 implements DispatchPredicate {
    @Override public String id() { return "DSP-048"; }
    @Override public String description() { return "Site load above threshold 2.4 (DSP-048)"; }
