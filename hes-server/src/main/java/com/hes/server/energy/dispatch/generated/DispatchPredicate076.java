...
@Component
public class DispatchPredicate076 implements DispatchPredicate {
    @Override public String id() { return "DSP-076"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-076)"; }
