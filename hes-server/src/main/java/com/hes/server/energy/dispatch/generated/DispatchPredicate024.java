...
@Component
public class DispatchPredicate024 implements DispatchPredicate {
    @Override public String id() { return "DSP-024"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-024)"; }
