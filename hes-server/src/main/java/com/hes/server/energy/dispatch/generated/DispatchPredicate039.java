...
@Component
public class DispatchPredicate039 implements DispatchPredicate {
    @Override public String id() { return "DSP-039"; }
    @Override public String description() { return "PV production above threshold 5.25 (DSP-039)"; }
