...
@Component
public class DispatchPredicate085 implements DispatchPredicate {
    @Override public String id() { return "DSP-085"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-085)"; }
