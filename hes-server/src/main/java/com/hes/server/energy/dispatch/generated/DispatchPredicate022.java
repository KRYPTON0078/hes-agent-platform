...
@Component
public class DispatchPredicate022 implements DispatchPredicate {
    @Override public String id() { return "DSP-022"; }
    @Override public String description() { return "SOC above threshold 32 (DSP-022)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        BigDecimal v = signals.getOrDefault("soc", BigDecimal.ZERO);
        return v.compareTo(new BigDecimal("32")) > 0;
    }
}