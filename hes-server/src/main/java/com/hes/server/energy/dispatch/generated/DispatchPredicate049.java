...
@Component
public class DispatchPredicate049 implements DispatchPredicate {
    @Override public String id() { return "DSP-049"; }
    @Override public String description() { return "PV production above threshold 2.75 (DSP-049)"; }
