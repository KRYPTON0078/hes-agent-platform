...
@Component
public class DispatchPredicate045 implements DispatchPredicate {
    @Override public String id() { return "DSP-045"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-045)"; }
