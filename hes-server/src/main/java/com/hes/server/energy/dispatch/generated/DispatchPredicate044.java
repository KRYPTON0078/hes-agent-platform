...
@Component
public class DispatchPredicate044 implements DispatchPredicate {
    @Override public String id() { return "DSP-044"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-044)"; }
