...
@Component
public class DispatchPredicate001 implements DispatchPredicate {
    @Override public String id() { return "DSP-001"; }
    @Override public String description() { return "SOC below threshold 11 (DSP-001)"; }
