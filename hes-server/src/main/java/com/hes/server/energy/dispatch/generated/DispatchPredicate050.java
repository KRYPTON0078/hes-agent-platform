...
@Component
public class DispatchPredicate050 implements DispatchPredicate {
    @Override public String id() { return "DSP-050"; }
    @Override public String description() { return "Export watts above threshold 3350 (DSP-050)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("3350")) > 0;
    }
}