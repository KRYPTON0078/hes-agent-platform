...
@Component
public class DispatchPredicate084 implements DispatchPredicate {
    @Override public String id() { return "DSP-084"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-084)"; }
