...
@Component
public class DispatchPredicate058 implements DispatchPredicate {
    @Override public String id() { return "DSP-058"; }
    @Override public String description() { return "Site load above threshold 5.4 (DSP-058)"; }
