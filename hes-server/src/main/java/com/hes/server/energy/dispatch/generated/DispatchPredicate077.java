...
@Component
public class DispatchPredicate077 implements DispatchPredicate {
    @Override public String id() { return "DSP-077"; }
    @Override public String description() { return "Battery temperature above threshold 52 (DSP-077)"; }
