...
@Component
public class DispatchPredicate072 implements DispatchPredicate {
    @Override public String id() { return "DSP-072"; }
    @Override public String description() { return "SOC above threshold 82 (DSP-072)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        BigDecimal v = signals.getOrDefault("soc", BigDecimal.ZERO);
        return v.compareTo(new BigDecimal("82")) > 0;
    }
}