...
@Component
public class DispatchPredicate006 implements DispatchPredicate {
    @Override public String id() { return "DSP-006"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-006)"; }
