...
@Component
public class DispatchPredicate073 implements DispatchPredicate {
    @Override public String id() { return "DSP-073"; }
    @Override public String description() { return "Import watts above threshold 2917 (DSP-073)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("2917")) > 0;
    }
}