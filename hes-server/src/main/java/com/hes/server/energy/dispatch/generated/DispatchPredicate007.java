...
@Component
public class DispatchPredicate007 implements DispatchPredicate {
    @Override public String id() { return "DSP-007"; }
    @Override public String description() { return "Battery temperature above threshold 42 (DSP-007)"; }
