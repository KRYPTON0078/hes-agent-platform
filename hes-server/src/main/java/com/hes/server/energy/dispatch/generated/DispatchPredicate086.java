...
@Component
public class DispatchPredicate086 implements DispatchPredicate {
    @Override public String id() { return "DSP-086"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-086)"; }
