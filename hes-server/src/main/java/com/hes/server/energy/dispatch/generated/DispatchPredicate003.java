...
@Component
public class DispatchPredicate003 implements DispatchPredicate {
    @Override public String id() { return "DSP-003"; }
    @Override public String description() { return "Import watts above threshold 887 (DSP-003)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("887")) > 0;
    }
}