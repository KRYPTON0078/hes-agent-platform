...
@Component
public class DispatchPredicate040 implements DispatchPredicate {
    @Override public String id() { return "DSP-040"; }
    @Override public String description() { return "Export watts above threshold 2980 (DSP-040)"; }
    @Override public boolean matches(Map<String, BigDecimal> signals) {
        ...
        return v.compareTo(new BigDecimal("2980")) > 0;
    }
}