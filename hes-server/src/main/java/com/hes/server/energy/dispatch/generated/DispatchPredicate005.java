...
@Component
public class DispatchPredicate005 implements DispatchPredicate {
    @Override public String id() { return "DSP-005"; }
    @Override public String description() { return "Grid frequency above threshold 50.5 (DSP-005)"; }
