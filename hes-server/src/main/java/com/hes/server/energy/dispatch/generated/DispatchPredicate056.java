...
@Component
public class DispatchPredicate056 implements DispatchPredicate {
    @Override public String id() { return "DSP-056"; }
    @Override public String description() { return "Demand response active flag 1 (DSP-056)"; }
