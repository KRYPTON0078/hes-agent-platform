...
@Component
public class DispatchPredicate074 implements DispatchPredicate {
    @Override public String id() { return "DSP-074"; }
    @Override public String description() { return "Grid frequency below threshold 49.7 (DSP-074)"; }
